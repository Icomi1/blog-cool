  ...
  return (
    <section className="w-full py-20">
        <h1 className="heading">
            我的 <span className="text-purple">自由职业项目</span>
        </h1>
      <div className="my-20 flex flex-col lg:flex-row items-center 
      justify-center gap-4">
        <Card 
        title="项目名称一" 
        icon={<AceternityIcon order= "工作 1"  />}
        description="项目描述，做了什么，得到了什么出色的结果或者学到了什么新技能有什么收获.我学习了web3相关的技术，包括Solidity语言 了解了区块链的原理、加密货币的应用。从前端到后端从0到1实践完成一个完整的项目"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
        title="项目名称2" 
        icon={<AceternityIcon order= "工作 2"/>}
        description="项目描述，做了什么，得到了什么出色的结果或者学到了什么新技能有什么收获.我学习了web3相关的技术，包括Solidity语言 了解了区块链的原理、加密货币的应用。从前端到后端从0到1实践完成一个完整的项目"
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
        title="项目名称3" 
        icon={<AceternityIcon order= "工作 3" />}
        description="项目描述，做了什么，得到了什么出色的结果或者学到了什么新技能有什么收获.我学习了web3相关的技术，包括Solidity语言 了解了区块链的原理、加密货币的应用。从前端到后端从0到1实践完成一个完整的项目"
        >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="dark:text-white opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition 
        duration-200 text-center text-3xl">
          {title}
        </h2>
